      ...
      default:
        return (
          <div className="bg-white rounded-2xl p-12 shadow-lg text-center">
            <div
              className={`w-20 h-20 rounded-2xl bg-gradient-to-r ${module.color} flex items-center justify-center mx-auto mb-6`}
            >
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              This module provides comprehensive {module.name.toLowerCase()}{" "}
              management features. Connect your existing {module.name} component
              here or build new functionality.
            </p>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div
                className={`p-3 rounded-xl bg-gradient-to-r ${module.color}`}
              >
